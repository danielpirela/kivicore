...
export const CitasToggle = ({ citas, pacientes }: Props) => {
    ...
    return (
        <div className='flex flex-col justify-start items-start p-2'>
            <button
                className='bg-orange-500 text-white px-4 py-2 rounded-md shadow-lg w-auto h-auto'
            ...
            {isActive &&
                ...
                citas.map((cita: Cita, index) => {
                    return (
                        <ul
                            className='shadow-md flex space-x-2 p-2 rounded-md mt-2 ring-2 ring-indigo-600'
                            key={cita.id}
                        >
                        ...
                        cita.status !== 'Programada'
                            ...
                            <li>
                                <button
                                    className={
                                        'rounded-xl px-2 text-white bg-blue-500'
                                    }
                                    onClick={e => {
                                        handleCheck(e, index)
                                    }}
