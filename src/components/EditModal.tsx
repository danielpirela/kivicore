...
export const EditModal =  ({cita}:Props) => {
    ...
    return (
        <div className='fixed top-0 left-0 bg-none min-w-full min-h-screen flex justify-center items-center overflow-hidden'>
            <div className='w-auto h-52 bg-slate-100 flex flex-col justify-center items-center rounded-lg p-4 shadow-lg ring-2 ring-indigo-700 '>
