...
export default function page () {
    ...
    const handleSubmit = async (e:any) => {
        ...
        if (!name || !username || !phone || !email || !password || !dni || !gender || !status){
            setIsCreated(false)
        }
        ...
        <div className="relative flex flex-col justify-center items-center min-h-screen overflow-hidden bg-slate-100 min-w-full animate-fade-left animate-delay-150 p-4 " >
            <div className="w-auto p-6 m-auto bg-white rounded-md shadow-xl ring-2 ring-indigo-600 lg:max-w-xl ">
                ...
                <form className="mt-6" onSubmit={handleSubmit}>
                    ...
                    <div className="mt-6">
                        <input type="submit" value='Editar' className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-indigo-700 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600"/>
                    </div>
                </form>
            </div>
        </div>
