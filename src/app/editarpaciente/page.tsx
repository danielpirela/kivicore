...
import { getPaciente } from '@/utils/fetchData'
...
export default function page() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        const res = await axios.put(`/api/paciente/${idPaciente}`, {
            username: username,
            dni: Number(dni),
            phone: Number(phone),
            email: email,
                    ...
                    <div className='mb-2 text-black'>
                        <div className='flex justify-start items-center'>
                            ...
                            <input
                                ...
                                name='genero'
                                type='radio'
                                className='ml-1 max-w-[16px] text-black bg-white focus:border-indigo-400 focus:ring-indigo-300'
                            />
                        </div>
                        <div className='flex justify-start items-center'>
                            ...
                            <input
                                ...
                                name='genero'
                                type='radio'
                                className=' ml-1 max-w-[16px] text-indigo-700 bg-white  focus:border-indigo-400 focus:ring-indigo-300'
                            />
                        </div>
                    </div>
                    ...
                    <div className='mb-2 text-black'>
                        <div className='flex justify-start items-center'>
                            ...
                            <input
                                ...
                                name='estado'
                                type='radio'
                                className='max-w-[16px] ml-1 text-black bg-white focus:border-indigo-400 focus:ring-indigo-300'
                            />
                        </div>
                        <div className='flex justify-start items-center'>
                            ...
                            <input
                                ...
                                name='estado'
                                type='radio'
                                className='text-indigo-700 max-w-[16px] ml-1 bg-white focus:border-indigo-400 focus:ring-indigo-300 flex-1'
                            />
                        </div>
                    </div>
                    <div className='mt-6'>
