...
function page({ searchParams }: any) {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (password === confirmP) {
            ...
            setIsUpdated(true)
            window.location.replace('/loginmedico')
        }
    }
    ...
    return (
        <div className='relative flex flex-col justify-center items-center min-h-screen overflow-hidden bg-slate-100 min-w-full'>
            {isUpdated && (
                <div
                    id='toast-simple'
                    className='flex items-center w-full max-w-sm p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white divide-x  divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 dark:bg-gray-800 animate-fade-left delay-150 absolute right-4 bottom-4'
                    role='alert'
                >
                    <svg
